 ...
 *
 */
public class SystemMessageEvent extends NotifyEvent
{
	 ...
	 * @param systemMessage
	 */
	public SystemMessageEvent(String systemMessage)
	{
	...
	{
		return NotifyEventType.SYSTEM_MESSAGE;
	}
	...
	{
		return "SystemMessageEvent [systemMessage=" + systemMessage
